      ...
      <section id="contact" className="contact">
        ...
        <div className="contactbuttons">
          <a
            ...
            href="mailto:caprilewis1042@gmail.com"
          >
          ...
          <a
            class="btn btn-large btn primary"
            href="https://www.linkedin.com/in/capri-lewis-64a73410b/"
          >
            <i className="fa fa-linkedin-square" style={iconStyle} />{" "}
          </a>
          <a
            class="btn btn-large btn primary"
            href="https://github.com/Capril1042"
          >
            <i className="fa fa-github" style={iconStyle} />
          </a>
        </div>
        <a href="#home">
